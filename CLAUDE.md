...
## Laatst bijgewerkt: 30 maart 2026 (MEDIA 9→3 Consolidatie)
...
│   └── ai-trainer/                                    ← MEDIA consolidatie: AI Trainer (6 tabs)
│       └── components/
│           └── AiTrainerPage.tsx                  ← 6-tab page (AI Models, Brand Models, Photography, Animation, Voices, Sound Effects)
