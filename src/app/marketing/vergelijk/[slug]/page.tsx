  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <p className="text-xs text-gray-500 mb-14 max-w-2xl">
        Hoeveel scheelt het? In onze pilotmeting gemiddeld +7 punten on-brand vs. AI zonder
        merkcontext bij een eerlijke, volledige briefing (en bijna +10 op de nieuwsbrief); het
        verschil is het grootst bij magere briefings. Meer over de meting:{' '}
