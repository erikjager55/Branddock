  ...
  try {
    ...
    const persona = await prisma.persona.create({
      data: {
        ...
        preferredChannels: original.preferredChannels ?? undefined,
        techStack: original.techStack ?? undefined,
        quote: original.quote,
        bio: original.bio,
        buyingTriggers: original.buyingTriggers ?? undefined,
        decisionCriteria: original.decisionCriteria ?? undefined,
        isLocked: false,
        lockedById: null,
        lockedAt: null,
        workspaceId,
