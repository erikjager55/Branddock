...
import { buildCreativePipelineContext, generateCreativeConcepts } from '@/lib/campaigns/strategy-chain';
import type { StrategicIntent, HumanInsight } from '@/lib/campaigns/strategy-blueprint.types';
import { z } from 'zod';
...
/**
 * POST /api/campaigns/wizard/strategy/generate-concepts
 * Generates creative concepts based on a selected insight.
 * SSE stream with progress events + final concepts result.
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[POST /api/campaigns/wizard/strategy/generate-concepts]', error);
