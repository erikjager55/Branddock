...
/** GET /api/media/ai-images/[id] — Get a single generated image */
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(mapGeneratedImage(image as unknown as Record<string, unknown>));
  } catch (error) {
...
/** PATCH /api/media/ai-images/[id] — Update a generated image */
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json(mapGeneratedImage(updated as unknown as Record<string, unknown>));
  } catch (error) {
    console.error('Error updating generated image:', error);
    return NextResponse.json({ error: 'Failed to update generated image' }, { status: 500 });
  }
}

/** DELETE /api/media/ai-images/[id] — Delete a generated image */
export async function DELETE(
  ...
  try {
    ...
    try {
      ...
      console.warn('Failed to delete storage file for generated image:', id);
    }
