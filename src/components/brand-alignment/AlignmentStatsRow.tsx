  ...
  return (
    <div className="flex gap-4">
      ...
      <div className="bg-green-50 rounded-lg p-4 flex-1">
        ...
        <div className="text-sm text-gray-500">{t('stats.aligned')}</div>
      </div>
      ...
      <div className="bg-orange-50 rounded-lg p-4 flex-1">
        ...
        <div className="text-sm text-gray-500">{t('stats.needsReview')}</div>
      </div>
      ...
      <div className="bg-red-50 rounded-lg p-4 flex-1">
        ...
        <div className="text-sm text-gray-500">{t('stats.misaligned')}</div>
      </div>
    </div>
  );
}
