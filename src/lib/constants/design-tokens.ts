  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'brandvoice', label: 'Brand Voice', icon: 'Mic2', href: '/knowledge/brand-voice' },
...
export const PAGE_ICONS: Record<string, { icon: string; bgColor: string; iconColor: string }> = {
  ...
  'brand-voice':       { icon: 'Mic2',            bgColor: 'bg-teal-50',    iconColor: 'text-teal-600' },
...
export const MODULE_META: Record<string, {
  ...
  'brand-voice': {
    title: 'Brand Voice',
    subtitle: 'Verbal identity — tone, vocabulary, channel-tones and writing samples',
    phase: 'Phase 3',
    comingSoonDescription: '',
  },
  'personas': {
...
export const MODULE_GRADIENTS = {
  ...
  'brandvoice':        { from: 'from-teal-500',    to: 'to-emerald-600',  icon: 'Mic2' },
