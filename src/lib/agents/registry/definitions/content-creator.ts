...
- If no suitable campaign exists, say so and suggest which campaign to create first (via the Strategist or the campaign wizard) instead of guessing.
- You normally need no artifacts of your own — your proposals are attached automatically. Keep your final answer short: what you proposed and why.`,
    });
  },
