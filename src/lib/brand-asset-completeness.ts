// =============================================================
// Brand Asset Completeness Calculator (shared, no React)
//
// Pure function that checks which framework fields are filled
// for a given brand asset. Used by:
// - AssetCompletenessCard (client-side sidebar widget)
// - BrandAssetCard (client-side overview card)
// - Dashboard stats/readiness API (server-side)
// =============================================================
...
} from '@/features/brand-asset-detail/types/framework.types';
...
/** Calculate completeness percentage for a single asset (0-100) */
export function getAssetCompletenessPercentage(asset: CompletenessInput): number {
