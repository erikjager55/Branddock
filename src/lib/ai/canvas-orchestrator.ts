...
function buildRegenerationPrompt(
  ...
  const userPrompt = [
    ...
    '',
    'FORMATTING: Use markdown in the "content" field — ## headings (sentence case, NOT Title Case), ### sub-headings, **bold**, *italic*, - bullet lists, and blank lines between paragraphs. Never output unformatted walls of text.',
    '',
    'Response schema:',
    '{',
    '  "components": [',
