...
# OUTPUT-SCHEMA
{
  ...
  "features": {
    ...
    "items": [{ "icon": string (lucide-icon naam, geen emoji), "heading": string (2-4 woorden), "body": string (1-2 zinnen benefit-frame) }] (3 of 4 items; 5 verstoort grid-balans. Elke feature BEWIJST één pilaar van de hero-belofte, dus geen losse willekeurige features. Samen dekken ze de kern-belofte uit de headline/subhead)
  },
  "socialProof": {
...
15. **Maximaal 1 opsommende ontkenning per pagina**: constructies als "geen X, geen Y" zijn maximaal 1 keer toegestaan op de hele pagina en NOOIT als drieslag of met een "alleen Z"-afsluiting ("geen X, geen Y, alleen Z" is verboden). Formuleer voordelen positief: wat de lezer WEL krijgt.
