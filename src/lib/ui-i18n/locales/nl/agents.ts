...
const ns = {
  ...
  detail: {
    ...
    schedules: {
      title: 'Schema’s',
      subtitle:
        'Laat deze agent automatisch draaien op een terugkerend schema — resultaten landen in de Resultaten-inbox, zonder open tabblad.',
      empty: 'Nog geen schema’s.',
      newButton: 'Nieuw schema',
      defaultTask: 'Standaardtaak',
      nextRun: 'volgende run {{relative}}',
      paused: 'gepauzeerd',
      pause: 'Pauzeer',
      resume: 'Hervat',
      delete: 'Verwijder',
      deleteConfirm: 'Dit schema verwijderen? Geplande runs stoppen direct.',
      loadError: 'Kon schema’s niet laden',
      retry: 'Opnieuw proberen',
      updateError: 'Kon het schema niet bijwerken',
      deleteError: 'Kon het schema niet verwijderen',
      summary: {
        daily: 'Dagelijks om {{time}}',
        weekly: 'Wekelijks op {{day}} om {{time}}',
        monthly: 'Maandelijks op dag {{day}} om {{time}}',
        everyMinute: 'Elke minuut (dev)',
      },
      cadences: {
        DAILY: 'Dagelijks',
        WEEKLY: 'Wekelijks',
        MONTHLY: 'Maandelijks',
        EVERY_MINUTE: 'Elke minuut (dev)',
      },
      weekdays: {
        1: 'maandag',
        2: 'dinsdag',
      ...
      form: {
        ...
        time: 'Tijd',
        message: 'Opdracht',
        messagePlaceholder: 'Beschrijf de terugkerende opdracht...',
        messageRequired: 'Beschrijf eerst de opdracht.',
        create: 'Schema aanmaken',
        creating: 'Aanmaken...',
        createError: 'Kon het schema niet aanmaken',
        cancel: 'Annuleren',
      },
    },
    memory: {
      ...
      delete: 'Vergeet',
      deleteConfirm: 'Deze herinnering vergeten? Dit kan niet ongedaan worden gemaakt.',
