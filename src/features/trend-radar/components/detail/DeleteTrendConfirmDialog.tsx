...
interface DeleteTrendConfirmDialogProps {
  trendTitle: string;
  isDeleting: boolean;
  onConfirm: () => void;
  onCancel: () => void;
...
/** Modal delete confirmation with "Type DELETE to confirm" pattern */
export function DeleteTrendConfirmDialog({
  trendTitle,
  isDeleting,
  onConfirm,
  onCancel,
}: DeleteTrendConfirmDialogProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      ...
      <div className="relative w-[400px] rounded-xl bg-white p-6 shadow-xl mx-4">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-base font-semibold text-gray-900">Delete Trend</h2>
        ...
        <p className="text-sm text-gray-600 mb-4">
          Are you sure you want to delete <span className="font-semibold text-gray-900">{trendTitle}</span>? All associated data will be permanently removed.
        </p>
