      ...
      <div className="border border-gray-200 rounded-lg p-4 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="text-center p-2 bg-gray-50 rounded">
            ...
            <span className="text-xs text-gray-400">{t('performance.views')}</span>
            <p className="text-sm font-medium text-gray-300">—</p>
          </div>
          <div className="text-center p-2 bg-gray-50 rounded">
            <MousePointer className="h-3.5 w-3.5 text-gray-400 mx-auto mb-1" />
            <span className="text-xs text-gray-400">{t('performance.clicks')}</span>
            <p className="text-sm font-medium text-gray-300">—</p>
          </div>
          <div className="text-center p-2 bg-gray-50 rounded">
            <TrendingUp className="h-3.5 w-3.5 text-gray-400 mx-auto mb-1" />
            <span className="text-xs text-gray-400">{t('performance.ctr')}</span>
            <p className="text-sm font-medium text-gray-300">—</p>
          </div>
        </div>
        ...
        <EmptyState
          icon={BarChart3}
          title={t('performance.comingSoonTitle')}
          description={t('performance.comingSoonDescription')}
        />
      </div>
    </div>
  );
