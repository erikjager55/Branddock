...
import { FileText, Clock, Type, Copy, Check, AlertTriangle } from 'lucide-react';
...
export function TextComponentEditor({ component, onContentChange, deliverableTypeId }: TextComponentEditorProps) {
  ...
  const validationResult = React.useMemo(
    () => validateContentConstraints(localContent, deliverableTypeId),
    [localContent, deliverableTypeId],
  );
