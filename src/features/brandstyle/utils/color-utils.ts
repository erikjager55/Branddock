...
export function contrastWithWhite(hex: string): string {
  return wcagLevel(contrastRatio(hex, "#FFFFFF"));
}

export function contrastWithBlack(hex: string): string {
  return wcagLevel(contrastRatio(hex, "#000000"));
}
