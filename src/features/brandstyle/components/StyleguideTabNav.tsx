...
import { Image as ImageIcon, Palette, Type, Ruler, Blocks, Camera, Layers, Code2, MonitorSmartphone, FileText, Clock } from "lucide-react";
...
const TABS: Tab[] = [
  ...
  // W4 designbibliotheek-verbeterplan: stijl toegepast op echte content
