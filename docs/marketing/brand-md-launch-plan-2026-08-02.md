...
| 5 | Landingspagina EN (+ NL): uitleg, generator-CTA, "works with"-rij, link naar upstream spec | 0 | Ruimhartig linken naar thebrand.md — omarmen moet zichtbaar zijn + **use-hub** (`/brandmd/use`): per-tool-tutorials (30-sec-recept + clip), publiek zonder e-mail — dicht het "bestand zonder plan"-gat (touchpoint 1.6) en vangt ontvangers van andermans bestanden |
