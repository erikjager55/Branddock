...
| **ADR-2** | Brandclaw agent-architectuur | Vóór Phase 3 start | Tool-use pattern (Anthropic SDK), versioned observations, immutable DataSnapshot, no-autonomy-in-stub. Beschrijf upgrade-pad naar Campaign Builder + Measurement nodes. |
