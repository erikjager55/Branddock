...
1. **Agents Fase 1 — `agents-motor-wiring` ✅ + `agents-ui-inbox` ✅ DONE 2026-07-06** (#360/#361, beide gemerged naar main incl. post-merge hidden-agent-guard) — 5 persona-agents live (Nova/Vera/Stella/Milo/Marco), propose-only confirm-keten, volledige Agents-UI + Claw-scoping. Review: 7 reviewer-runs, 3 CRITICAL + 18 WARNINGs gefixt. **Volgende**: `agents-data-analyst` (in-progress) — daarna Fase 1 compleet. Detail: changelog #360/#361 + tasks/done/.
