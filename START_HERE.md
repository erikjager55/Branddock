...
3. **🤖/🔐 Afhechting (~28-07).** Ada-drempel-kalibratie + Vera-go/no-go + de CSP-enforce-flip in één sessie · `repair-defaults` op prod draaien voor de BB-`contentLanguage` · onboarding-testers (user).
