...
2. **🚀 `brand.md` als open standaard — naar voren gehaald (user-directive 2026-08-02).** [`tasks/brand-md-open-standaard.md`](tasks/brand-md-open-standaard.md): publieke spec + workspace-export (UI/REST/MCP) + gratis generator via de bestaande website-scan + landingspagina (±2d, was €100k-plan Fase 4). **Erik-gate vooraf**: naamgeving/positionering-akkoord — publieke standaard-claim. Onderbouwing: `docs/reports/concurrentieanalyse-2026-08-02.md` §4.2/§6.
