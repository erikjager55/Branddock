...
async function main() {
  ...
  writeFileSync(
    resolve(outDir, '2026-08-20-per-content-type-herijking-raw.json'),
  ...
  writeFileSync(resolve(outDir, '2026-08-20-per-content-type-herijking-report.md'), lines.join('\n'));
  console.log(`\nReport written: docs/experiments/2026-08-20-per-content-type-herijking-report.md`);
