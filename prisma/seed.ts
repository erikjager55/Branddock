...
Respond only with valid JSON.`,
      fieldSuggestionsConfig: [
        ...
        { field: 'frameworkData.functionalBenefit', label: 'Functional Benefit', type: 'text' as const, extractionHint: 'Extract the tangible quality that is inseparable from the brand\'s identity and heritage' },
        { field: 'frameworkData.emotionalBenefit', label: 'Emotional Benefit', type: 'text' as const, extractionHint: 'Extract the feeling that defines the brand\'s core character' },
        { field: 'frameworkData.selfExpressiveBenefit', label: 'Self-Expressive Benefit', type: 'text' as const, extractionHint: 'Extract how the brand inherently represents a customer\'s identity' },
        ...
        { field: 'frameworkData.proofPoints', label: 'Proof Points', type: 'array' as const, extractionHint: '3-5 pieces of evidence proving the brand\'s authentic identity (founding principles, heritage, consistent behaviors over time) as a JSON array of strings' },
