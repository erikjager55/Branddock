...
import { MEDIUM_ENRICHMENT_DEFAULTS } from "../src/lib/seed-data/medium-enrichment";
...
Respond only with valid JSON.`,
  ...
  // ============================================
  // MediumEnrichment-defaults: gedeelde bron met /api/admin/repair-defaults
  // (src/lib/seed-data/medium-enrichment.ts) — zie pilot-incident 2026-07-16.
  const mediumEnrichmentData = MEDIUM_ENRICHMENT_DEFAULTS;
