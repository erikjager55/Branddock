...
| [`pricing-credits-billing`](tasks/pricing-credits-billing.md) | Credit-based billing — prepaid bundel + top-up + metering-wiring (incl. background-jobs) + iDEAL/SEPA + BTW. ADR [`2026-07-07`](docs/adr/2026-07-07-pricing-credits-launch.md). | 3-4wk (gefaseerd 0-6) | #6-7 | open — **launch-blocker** (pricing besloten; fair-use-rem nog niet aangesloten) |
