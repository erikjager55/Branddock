...
|---|---|---|---|---|
| `content-items-test-coverage` | Handmatige testplan 53 types (representanten + Ronde 1 + Ronde 2). Playbook: `docs/playbooks/testplan-content-items.md`. Levert baseline-data voor golden-sets. Representanten ✅ 2026-07-01 (6/8 passed, 2 hidden-skip newsletter/press-release, 0 bugs). Varianten + Ronde 2 open. | 1d representanten + 2-3d full | #4 (representanten) + parallel met #5.B | in-progress (representanten done) |
...
5. ✅ testplan-content-items Ronde 1 representanten — 2026-07-01, 6/8 passed op Napking (0 bugs), 2/8 hidden-skip (newsletter/press-release). Effie-fix runtime-herbevestigd (grep=null). Varianten (45 types) open.
