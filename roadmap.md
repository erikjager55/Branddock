...
| [`competitor-content-item-discovery`](tasks/competitor-content-item-discovery.md) | Sitemap-first producer voor de (lege) `CompetitorContentItem`-tabel. Task-file + 3 probes aanwezig (A2 sitemap 71%, A3 classifier 100%); nog NIET gebouwd. | 5-6d | #6-7 | open — ready-to-build |
